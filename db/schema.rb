...
ActiveRecord::Schema.define(version: 20160112090458) do
  ...
  add_index "poems", ["title"], name: "index_poems_on_title", using: :btree
  ...
  add_index "stanzas", ["author_id"], name: "index_stanzas_on_author_id", using: :btree
